...
namespace Ch03Ex02
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"The profuct of {firstNumber} and {secondNumber} is " + $"{firstNumber * secondNumber}.");
            Console.WriteLine($"The result of dividing {firstNumber} by {secondNumber} is " + $"{firstNumber / secondNumber}.");
            Console.WriteLine($"The reminder after dividing {firstNumber} by {secondNumber} is " + $"{firstNumber % secondNumber}.");
            Console.ReadKey();
        }
    }
}
